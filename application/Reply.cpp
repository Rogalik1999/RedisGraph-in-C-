...
std::ostream& operator<< (std::ostream& os, const Reply::Statistics& rhs){
...
std::ostream& operator<< (std::ostream& os, const Reply::Procedure& rhs){
...
std::ostream& operator<< (std::ostream& os, const Reply::Record& rhs){
...
std::ostream& operator<< (std::ostream& os, const Reply::ResultSet& rhs){
...
template std::string Reply::Record::getValue<std::string>(int i);
template int Reply::Record::getValue<int>(int i);
template bool Reply::Record::getValue<bool>(int i);
template double Reply::Record::getValue<double>(int i);
template Reply::RedisArray Reply::Record::getValue<Reply::RedisArray>(int i);
template Edge Reply::Record::getValue<Edge>(int i);
template Node Reply::Record::getValue<Node>(int i);
