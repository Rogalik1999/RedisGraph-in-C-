...
#ifndef RedisGraphParserH
#define RedisGraphParserH
#define RESULT_OK 1
...
private:
	...
	Reply::Procedure* properties_keys;
...
public:
	...
	void setProceduresPointers(Reply::Procedure* labels, Reply::Procedure* relation_types, Reply::Procedure* properties_keys);
	...
	int makeResultSet(Reply::ResultSet& result_set);
	///Tworzenie procedury z lista RelationTypes
	int makeProcedureRelationType(Reply::Procedure& procedure);
    ///Tworzenie procedury z lista Labels
	int makeProcedureLabel(Reply::Procedure& procedure);
    ///Tworzenie procedury z lista PropertyKeys
	int makeProcedurePropertyKey(Reply::Procedure& procedure);
    ///Tworzenie statystyk
	int makeStatistics(Reply::Statistics& statistics);
