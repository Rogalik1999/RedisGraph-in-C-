...
void RedisGraphParser::setProceduresPointers(Reply::Procedure* labels, Reply::Procedure* relation_types, Reply::Procedure* properties_keys){
...
int RedisGraphParser::makeResultSet(Reply::ResultSet& result_set){
...
int RedisGraphParser::makeProcedureRelationType(Reply::Procedure& procedure){

    if(makeProcedureCall(31,procedure) != RESULT_OK ) return RESULT_UNFINISHED;
    return RESULT_OK;
}

int RedisGraphParser::makeProcedureLabel(Reply::Procedure& procedure){

    if(makeProcedureCall(19,procedure) != RESULT_OK ) return RESULT_UNFINISHED;
    return RESULT_OK;
}

int RedisGraphParser::makeProcedurePropertyKey(Reply::Procedure& procedure){

    if(makeProcedureCall(26,procedure) != RESULT_OK ) return RESULT_UNFINISHED;
    return RESULT_OK;
}

int RedisGraphParser::makeStatistics(Reply::Statistics& statistics){
...
/// private method
int RedisGraphParser::makeProcedureCall(int omit,Reply::Procedure& procedure){
...
int RedisGraphParser::takeRecordsofHeaderRow(Reply::ResultSet& result_set, bool ifInitialized){
...
int RedisGraphParser::takeValueType(Reply::ResultSet& result_set, bool ifInitialized){
