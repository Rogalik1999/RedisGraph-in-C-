...
ResultSet RedisGraph::get_return_response(std::string graph_name, std::string query, std::string return_alias){
...
Statistics RedisGraph::execute_query(std::string graph_name, std::string query){
...
Procedure RedisGraph::call_labels_procedure(std::string graph_name){
...
Procedure RedisGraph::call_relation_types_procedure(std::string graph_name){
...
Procedure RedisGraph::call_property_keys_procedure(std::string graph_name){
